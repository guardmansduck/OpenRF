...
namespace DiscordScopes { const String MESSAGES_READ = "messages.read"; const String MESSAGES_WRITE = "messages.write"; const String IDENTIFY = "identify"; }

namespace SMSLinks { const String API_BASE = "https://sms.example.com/api"; }
